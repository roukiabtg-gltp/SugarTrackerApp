          ...
          OutlinedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => EditPatientProfilePage(
                    patientId: widget.patientId,
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    _hCell(t('Date & Time','التاريخ والوقت','Date et heure'), flex: 3),
                    _hCell(t('Type','النوع','Type'), flex: 2),
                    _hCell(t('Value','القيمة','Valeur'), flex: 2),
                    _hCell(t('Source','المصدر','Source'), flex: 2),
                    _hCell(t('Actions','الإجراءات','Actions'), flex: 2),
                  ],
                ),
              ),
              const Divider(height: 1, color: Color(0xFFEDF2F7)),
              // Rows
              ...list.asMap().entries.map((mapEntry) {
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
                              child: Text(type,
                                  style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xFF2D3142))),
                            ),
                          ),
                          Expanded(
                            flex: 2,
