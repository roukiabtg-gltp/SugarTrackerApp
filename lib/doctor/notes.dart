...
class _NotesPageState extends State<NotesPage>
  ...
  String t(String en, String ar, String fr) => en;
  ...
  // ── BUILD ─────────────────────────────────────────────────────────────
  // ✅ الحل: Column عادي بدل CustomScrollView + SliverFillRemaining
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // ── Add Form (scrollable إذا ظهر) ──────────────────────
                if (_isAdding) _buildAddForm(),
              ],
            ),
          ),

          // ── TabBarView يأخذ المساحة المتبقية ✅ ──────────────────────
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
  ...
  Widget _buildAddForm() {
    ...
    final accentColor = isSecretary ? const Color(0xFF3B82F6) : const Color(0xFF3B82F6);
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisSize: MainAxisSize.min,   // ✅ مهم: لا يتمدد أكثر من اللازم
        children: [
          Row(
            children: [
              Icon(isSecretary ? Icons.send_rounded : Icons.note_add_outlined, color: accentColor, size: 20),
          ...
          TextField(
            ...
            maxLines: 3,   // ✅ قلصنا من 4 لـ 3 لتوفير مساحة
            decoration: InputDecoration(
          ...
          if (!isSecretary) ...[
            ...
            Wrap(
              ...
              children: _doctorTags.map((tag) {
                ...
                return ChoiceChip(
                  avatar: Icon(_tagIcons[tag], size: 14, color: selected ? color : Colors.grey),
                  label: Text(tag),
                  selected: selected,
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: isSecretary ? _sendSecretaryNote : _addDoctorNote,
              icon: Icon(isSecretary ? Icons.send_rounded : Icons.save_outlined, color: Colors.white, size: 18),
              label: Text(
                isSecretary
                    ? t('Send to Secretary', 'إرسال للسكريتير', 'Envoyer au secrétaire')
                    : t('Save Note', 'حفظ الملاحظة', 'Enregistrer la note'),
            ...
            children: [
              ...
              if (!_isAdding)
                Align(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () => _openAddForm(forSecretary: false),
              ...
              if (isEmpty)
                _buildEmpty(
                  t('No personal notes yet', 'لا توجد ملاحظات شخصية بعد', 'Aucune note personnelle'),
                  Icons.notes_rounded,
                )
              else
            ...
            children: [
              ...
              if (!_isAdding)
                Align(
                  alignment: Alignment.centerRight,
                  child: ElevatedButton.icon(
                    onPressed: () => _openAddForm(forSecretary: true),
              ...
              if (isEmpty)
                _buildEmpty(
                  t('No notes sent to secretary yet', 'لم ترسل أي ملاحظة للسكريتير بعد', 'Aucune note envoyée'),
                  Icons.send_outlined,
                )
              else
      ...
      itemBuilder: (_, i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isRead ? Colors.grey.shade100 : const Color(0xFF3B82F6).withOpacity(0.3),
              width: isRead ? 1 : 1.5,
            ),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: isRead ? Colors.grey.shade300 : const Color(0xFF3B82F6),
                ),
              ),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(_fmt(d['timestamp']), style: const TextStyle(fontSize: 11, color: Colors.grey)),
                  ],
                ),
              ),
            ],
...
class _NoteCard extends StatelessWidget {
  ...
  const _NoteCard({
    required this.title, required this.content, required this.tag,
    required this.tagColor, required this.tagIcon, required this.timestamp,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(tag, style: TextStyle(color: tagColor, fontSize: 11, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
              GestureDetector(
